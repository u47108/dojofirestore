...
public class SwaggerConfig {
  ...
  public static final Contact DEFAULT_CONTACT = new Contact("Firestore App", "https://github.com/u47108/dojofirestore",
      "@u47108");

  public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Firestore API Title", "Firestore API Description", "1.0",
